...
import '../controllers/teacher_qr_scanner_controller.dart';
import '../app/theme/app_theme.dart';

class TeacherQRScannerScreen extends StatelessWidget {
  TeacherQRScannerScreen({super.key});

  final TeacherQrScannerController controller = Get.put(TeacherQrScannerController());
        ...
        children: [
          ...
          Padding(
            ...
            child: Obx(() => Row(
              ...
              children: [
                ...
                _buildStat('Total', controller.totalTeachers.toString(), Colors.blue),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => Text(
                  'Scanned (${controller.scannedTeachers.length})',
                  style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                )),
                Obx(() => controller.scannedTeachers.isNotEmpty
                    ? TextButton.icon(
                        onPressed: controller.clearScannedTeachers,
          ...
          // List
          Expanded(
            child: Obx(() => controller.scannedTeachers.isEmpty
                ? Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        const SizedBox(height: 12),
                        Text('No teachers scanned', style: TextStyle(color: Colors.grey[600])),
                      ],
                    ),
                  )
                : ListView.builder(
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    itemCount: controller.scannedTeachers.length,
                    itemBuilder: (context, index) {
                      final teacher = controller.scannedTeachers[
                          controller.scannedTeachers.length - 1 - index];
  ...
  Widget _buildTeacherTile(teacher) {
    return Dismissible(
      key: Key(teacher.id),
      ...
      onDismissed: (_) => controller.removeTeacher(teacher.id),
      child: Container(
        margin: const EdgeInsets.only(bottom: 8),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // Text('${teacher.rollNumber} • ${teacher.classSection}',
